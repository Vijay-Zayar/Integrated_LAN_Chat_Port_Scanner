...
def chatClient(right_frame):
    ...
    # leave_btn = ttk.Button(inner_frame, text="Leave", bootstyle="WARNING", width=9, command=lambda: menus.chooseClientServer(right_frame))
    ...
    def connectToServer():
        ...
        if username != '' and HOST != '':
            ...
            message_box.show_warning("Host IP and User Name cannot be empty !", "Invalid Input", parent=hostIP_entry)
